...
print("TEST:")
recommendations = pd.read_sql("SELECT * FROM user_recommendations", create_engine(recommendation_db_url))
similarities = pd.read_sql("SELECT * FROM book_similarities", create_engine(recommendation_db_url))
